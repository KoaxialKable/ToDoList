      ...
      return (
        React.createElement("li", {key: this.props.id, className: "list-group-item"}, 
          React.createElement("span", null, this.props.text), 
              React.createElement("span", {ref: "btnEdit", onClick: this.editClick, className: "glyphicon glyphicon-pencil hover", style: {opacity: 0.1, paddingLeft: '7px'}, title: "Edit"}), 
              React.createElement("span", {ref: "btnDelete", onClick: this.deleteClick, className: "glyphicon glyphicon-remove hover", style: {color: 'red', opacity: 0.1, paddingLeft: '7px'}, title: "Delete"})
        )
      );
    }
  }
