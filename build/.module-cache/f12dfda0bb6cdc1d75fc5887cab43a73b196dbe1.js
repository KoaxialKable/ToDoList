      ...
      return (
        React.createElement("li", {key: this.props.id, className: "list-group-item"}, 
          ...
          React.createElement("div", {class: "btn-group", role: "group"}, 
            ...
            React.createElement("span", {ref: "btnEdit", onClick: this.updateClick, className: "glyphicon glyphicon-okay hover", style: {opacity: 0.55, paddingLeft: '7px'}, title: "Update"}), 
          React.createElement("span", {ref: "btnDelete", onClick: this.editClick, className: "glyphicon glyphicon-remove hover", style: {opacity: 0.55, paddingLeft: '7px'}, title: "Cancel Edit"})
          )
        )
      );
    } else {
