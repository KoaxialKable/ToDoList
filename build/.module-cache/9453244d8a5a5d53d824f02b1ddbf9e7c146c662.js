    ...
    return (
      React.createElement("div", {className: "TodoList"}, 
        ...
        React.createElement("ul", {className: "list-group"}, 
          listNodes, 
          React.createElement("li", {key: "add", className: "list-group-item"}, React.createElement("span", {className: "glyphicon glyphicon-plus hover", onClick: this.addNewItem, style: {opacity: 0.55}}))
        )
