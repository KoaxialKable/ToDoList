    ...
    if (editMode) {
      return (
        React.createElement("li", {key: this.props.id, className: "TodoRowEdit"}, 
          ...
          React.createElement("button", {type: "button", ref: "btnUpdate", onClick: this.updateClick}, "Update"), 
          React.createElement("button", {type: "button", ref: "btnCancel", onClick: this.editClick}, "Cancel")
        )
      );
    } else {
      return (
        React.createElement("li", {key: this.props.id, className: "TodoRow"}, 
          ...
          React.createElement("button", {type: "button", ref: "btnEdit", onClick: this.editClick}, "Edit"), 
          React.createElement("button", {type: "button", ref: "btnDelete", onClick: this.deleteClick}, "Delete")
        )
      );
    }
  }
