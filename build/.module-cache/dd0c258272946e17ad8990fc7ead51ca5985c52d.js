    ...
    return (
      React.createElement("div", {className: "TodoList"}, 
        ...
        React.createElement("ul", {className: "list-group"}, 
          listNodes, 
          React.createElement("li", {key: "add", className: "list-group-item"}, React.createElement("button", {type: "btn-default"}, "Add")), 
          React.createElement("li", null, React.createElement("span", {className: "glyphicon glyphicon-plus hover", onClick: this.addNewItem}))
        )
