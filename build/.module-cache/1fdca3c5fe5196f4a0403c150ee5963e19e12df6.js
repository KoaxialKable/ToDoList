    ...
    if (editMode) {
      ...
      return (
        React.createElement("li", {key: this.props.id, className: "TodoRow"}, 
          ...
          React.createElement("button", {type: "button", ref: "btnDelete", onClick: this.deleteClick, class: "btn btn-default"}, React.createElement("span", {class: "glyphicon glyphicon-remove"}), " Delete")
        )
      );
    }
  }
